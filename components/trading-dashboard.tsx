...
import { CryptoMarketBackground } from "./crypto-market-background"
...
export function TradingDashboard() {
  ...
  return (
    <div className="min-h-screen relative">
      <CryptoMarketBackground />

      <div className="relative z-10 p-2 md:p-4 space-y-3 md:space-y-4">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-3 md:gap-4">
          ...
          <div className="lg:col-span-2 space-y-3 md:space-y-4">
            ...
            <Card className="p-3 md:p-4 bg-card/80 backdrop-blur-sm">
              <h3 className="font-semibold mb-3 md:mb-4 text-foreground text-sm md:text-base">
